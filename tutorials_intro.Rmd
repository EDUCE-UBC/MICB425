...
You will work through a common workflow of TreeSAPP in a series of tutorials both with an example gene to familiarize yourself with the tools and then you will repeat the steps with a gene assigned to your group for which no reference package has ever been created.
