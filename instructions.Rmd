...
1.  Select your genes for analysis based on one of the following options:
    ...
    a.  Choose a geochemical cycle e.g. nitrogen and its associated genes in pathways with reference packages already available for TreeSAPP (see table of available [TreeSAPP reference packages]).
