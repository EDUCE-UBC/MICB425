...
1.  Select your genes for analysis based on one of the following options:
    ...
    a.  Choose a geochemical cycle e.g. nitrogen and its associated genes in pathways with reference packages already available for TreeSAPP (see table).
...
4.  Look for patterns in abundance, gene expression and diversity as a function of water column geochemical information.
...
3. What is the taxonomic breakdown of genes and transcripts within a given biogeochemcial cycle? 
