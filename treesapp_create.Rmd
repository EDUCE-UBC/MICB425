...
2) A profile HMM can be used to accomplish two things: first it can be used to remove sequences with remote homology to the protein family you're building a reference package for; each HMM alignment can be used to trim the input sequences to just the conserved regions improving the quality of the multiple sequence alignment and phylogeny.
