...
The following plot is for visualing the chemical profiles for each depth. This is not exhaustive but does include most of the molecules we're interested in.
