...
scp -r root@10.19.139.201:/data/ts_tutor/AmoA_assign/iTOL_output <path to Xmoa_sequences>
```
...
The output of this command is `p_amoA_FunGene9.5_isolates_update_assign/final_outputs/extra_annotated_marker_contig_map.tsv`. It contains an extra column for the functional annotations but is otherwise identical to the original `marker_contig_map.tsv` file.
