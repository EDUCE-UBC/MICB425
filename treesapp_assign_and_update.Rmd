...
The goal of this tutorial is to use the new updated reference package to classify the XmoA protein family with particulate methane monooxygenase (pMMO) and ammonia monooxygenase (AMO) sequences sourced from FunGene. 
...
-   the figure should look identical to Figure \@ref(fig:XmoA-FunGene).
...
![(\#fig:XmoA-Updated-tree)Updated tree topology with added 27 new sequences including Archae and Bacteria ](images/XmoA_update_ref_tree_iTOL.png)
