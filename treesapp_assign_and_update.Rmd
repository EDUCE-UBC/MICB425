...
* With TreeSAPP version 0.10.4, `treesapp update` no longer automatically retrains the reference package. Therefore, it doesn't require a FASTA file and the commands have been updated to reflect this change. This will save a significant amount of time!
...
__NOTE:__ `--fastx_input XmoA_seed.faa` has been removed from all `treesapp update` commands as of TreeSAPP 0.10.4 being installed on the server. See [above](#change-notes) for more details.
